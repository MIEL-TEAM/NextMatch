...
// Session: It's like a "log-in state" kept on the client-side (e.g., in a cookie). It stores information  the user while they're logged in, so they don't have to keep logging in during their visit.
