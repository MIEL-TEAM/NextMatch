...
export default function MielHomePage({ session }: MielHomePageProps) {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col justify-center items-center min-h-screen text-black fixed inset-0 px-6 sm:px-12"
    >
      <motion.div
        initial={{ y: -10 }}
        animate={{ y: [0, -10, 0] }}
      ...
      >
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-2xl md:text-7xl font-bold mt-6 bg-gradient-to-r from-[#F6D365] via-[#FFB547] to-[#E37B27] bg-clip-text text-transparent"
        >
          ברוכים הבאים ל - Miel
        </motion.h1>
      </motion.div>
